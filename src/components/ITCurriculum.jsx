...
import { 
  Code, Lock, Wifi, Download, CheckCircle2, ArrowRight 
} from 'lucide-react';

// Composant Carte Semestre (Adaptatif Light/Dark)
const SemesterCard = ({ id, title, courses, color }) => (
  ...
  >
    {/* Effet de lueur (Visible surtout en Dark Mode) */}
    ...
    <h3 className="text-2xl font-black text-gray-800 dark:text-white mb-6 mt-2 relative z-10">{title}</h3>
...
export default function ITCurriculum() {
  const curriculum = [
    {
      ...
      desc: "Fondamentaux Scientifiques & Introduction",
      semesters: [
        {
          id: "S1",
          title: "Bases Scientifiques & Algo",
          color: "bg-ucak-blue",
          courses: ["Algorithmique & Langage C", "Architecture des Ordinateurs", "Mathématiques I (Analyse)", "Électricité Générale", "Techniques d'Expression", "Anglais Technique I"]
        },
        {
          id: "S2",
          title: "Web & Physique Appliquée",
          color: "bg-ucak-green",
          courses: ["Programmation Web (HTML/CSS)", "Algorithmique Avancée", "Systèmes d'Exploitation 1", "Électronique Analogique", "Physique (Optique/Ondes)", "Bureautique Avancée"]
        }
      ]
    },
    {
      year: "Deuxième Année (L2)",
      desc: "Approfondissement Réseaux & Dév",
      semesters: [
        {
          id: "S3",
          title: "Infrastructures & Données",
          color: "bg-ucak-gold",
          courses: ["Architecture Réseaux (OSI/TCP-IP)", "Bases de Données (SQL)", "Programmation Orientée Objet (Java)", "Électronique Numérique", "Probabilités & Statistiques", "Marketing Digital"]
        },
        {
          id: "S4",
          title: "Systèmes & Télécoms",
          color: "bg-purple-500",
          courses: ["Administration Système Linux", "Théorie du Signal", "Transmission de Données", "Dév. Web Dynamique (PHP/JS)", "Réseaux Locaux & Commutation", "Droit de l'Informatique"]
        }
      ]
    },
    {
      ...
      semesters: [
        {
          ...
          color: "bg-red-500",
          courses: ["Sécurité Informatique", "Réseaux Sans Fil & Mobiles", "Administration Base de Données", "Virtualisation & Cloud", "Gestion de Projet (Agile/Scrum)", "Entrepreneuriat"]
        },
        {
          id: "S6",
          title: "Stage & Projet de Fin d'Études",
          color: "bg-indigo-500",
          courses: ["Projet Intégrateur (PFE)", "Stage en Entreprise (3 mois min.)", "Rédaction de Mémoire", "Soutenance devant Jury"]
        }
      ]
    }
  ];
  ...
  const specialities = [
    { id: "DAR", title: "Dév. Applications", icon: Code, desc: "Génie Logiciel, Mobile, Web Fullstack." },
    { id: "ASR", title: "Admin & Sécurité", icon: Lock, desc: "Cybersécurité, Pentesting, Audit, Cloud." },
      ...
      <section className="relative pt-32 pb-20 px-6">
        ...
        <div className="container mx-auto max-w-7xl relative z-10 text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-12 leading-relaxed">
            Devenez l'architecte du numérique. Une formation complète de la <span className="font-bold text-ucak-blue dark:text-white">L1 à la L3</span> alliant code, réseaux et infrastructures modernes.
          </p>
      ...
      <section className="py-20 px-6 relative">
        <div className="container mx-auto max-w-7xl">
          <div className="flex items-center gap-4 mb-16">
            ...
            <h2 className="text-3xl font-black uppercase tracking-widest text-center text-gray-900 dark:text-white">Programme Détaillé</h2>
            <div className="h-px bg-gray-200 dark:bg-white/20 flex-1"></div>
          </div>
      ...
      <section className="py-32 px-6 relative overflow-hidden">
        <div className="container mx-auto max-w-4xl relative z-10">
          <motion.div 
            ...
            className="rounded-[3rem] p-12 text-center relative overflow-hidden transition-all
              bg-white border border-gray-100 shadow-2xl
              dark:bg-ucak-blue/10 dark:backdrop-blur-2xl dark:border-ucak-blue/20 dark:shadow-none"
          >
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-10 max-w-xl mx-auto">
              Retrouvez le détail des coefficients, les modalités d'examen et le règlement intérieur dans la brochure officielle 2026.
            </p>

            <button className="inline-flex items-center gap-3 px-8 py-4 rounded-xl font-bold uppercase tracking-widest transition-all shadow-lg hover:-translate-y-1
              bg-ucak-blue text-white hover:bg-ucak-green
              dark:bg-white dark:text-black dark:hover:bg-ucak-green dark:hover:text-white">
              Télécharger le PDF <ArrowRight size={18} />
            </button>
          </motion.div>
        </div>
      </section>
