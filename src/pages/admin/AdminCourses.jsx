        ...
        <div className="bg-white dark:bg-ucak-dark-card p-8 rounded-[2rem] shadow-xl border border-gray-100 dark:border-white/5 relative overflow-hidden">
          ...
          {status === 'error' && (
            <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 text-red-600 rounded-xl flex items-center gap-3 animate-in fade-in slide-in-from-top-2 border border-red-200 dark:border-red-900/30">
              <AlertCircle size={20} />
              <span className="font-bold text-sm">Erreur lors de la publication.</span>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input name="instructor" value={formData.instructor} onChange={handleChange} required placeholder="Ex: Dr. Sene" className="w-full p-4 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 outline-none focus:border-ucak-blue font-bold" />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select name="category" value={formData.category} onChange={handleChange} className="w-full p-4 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 outline-none focus:border-ucak-blue font-bold">
